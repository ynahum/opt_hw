...
$$ x^* = -\frac{1}{2}A^{-1}(B^T\lambda + b)=-\frac{1}{2}
  ...
  \begin{bmatrix}
               \frac{1}{2} & 0 \\
               0 & 1 \\
  \end{bmatrix}(\begin{bmatrix} \frac{126}{9} \\ -\frac{1}{3}\\ \end{bmatrix} + \begin{bmatrix}   -20 \\ -2\\ \end{bmatrix})=$$
  $$=-\frac{1}{2}
  \begin{bmatrix}
               \frac{1}{2} & 0 \\
               0 & 1 \\
  \end{bmatrix}\begin{bmatrix}   -6 \\ -\frac{7}{3}\\ \end{bmatrix}=$$
$$=\begin{bmatrix} \frac{3}{2} & \frac{7}{6}\\ \end{bmatrix}^T$$
