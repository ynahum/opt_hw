...
If we assume $x_1=x_2 = -x_2$ we get the optimal point is $x_1=x_2=0 \Rightarrow \lambda^*_1 = 0, \lambda^*_3 = \frac{-21}{2} <0$ (from $\lambda_1^*(0.5x_1 +x_2 -1) = 0$ and $\nabla_x L(x^*,\lambda^*) = 0$), and we get a contradiction.\\
...
$$\frac{3}{2}\lambda^*_1 = \frac{53}{3} \Rightarrow$$
\rectres{$\lambda^*_1 = \frac{106}{9},\lambda^*_2 = \frac{103}{9}, \lambda^*_3=0$}
...
$$ x^* = -\frac{1}{2}A^{-1}(B^T\lambda + b)=-\frac{1}{2}
  ...
  \begin{bmatrix}
               \frac{1}{2} & 0 \\
               0 & 1 \\
  \end{bmatrix}(\begin{bmatrix} \frac{166}{9} \\ \frac{1}{3}\\ \end{bmatrix} + \begin{bmatrix}   -20 \\ -2\\ \end{bmatrix})=$$
  $$=-\frac{1}{2}
  \begin{bmatrix}
               \frac{1}{2} & 0 \\
               0 & 1 \\
  \end{bmatrix}\begin{bmatrix}   -\frac{14}{9} \\ -\frac{5}{3}\\ \end{bmatrix}=$$
$$=\begin{bmatrix} \frac{3}{2} & \frac{5}{6}\\ \end{bmatrix}^T$$
